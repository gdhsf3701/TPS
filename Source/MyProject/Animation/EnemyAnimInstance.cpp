...
{
	static ConstructorHelpers::FObjectFinder<UAnimMontage> HitMontageRef(TEXT("/Script/Engine.AnimMontage'/Game/Animation/Enemy/AM_EnemyHitMontage.AM_EnemyHitMontage'"));
...
void UEnemyAnimInstance::NativeUpdateAnimation(float DeltaSeconds)
{
	...
	bShouldMove = (Velocity.Size2D() > 3 && MovementComponent->GetCurrentAcceleration() != FVector::ZeroVector);
